...
<head>
    ...
    <link rel="stylesheet" type="text/css" href={{ url('backend/assets/css/animate.min.css') }}>
    <link rel="stylesheet" type="text/css" href={{ url('backend/assets/css/animation.css') }}>
    <link rel="stylesheet" type="text/css" href={{ url('backend/assets/css/bootstrap.css') }}>
    <link rel="stylesheet" type="text/css" href={{ url('backend/assets/css/bootstrap-select.min.css') }}>
    <link rel="stylesheet" type="text/css" href={{ url('backend/assets/css/style.css') }}>



    
    <link rel="stylesheet" href={{ url('backend/assets/font/fonts.css') }}>

    
    <link rel="stylesheet" href={{ url('backend/assets/icon/style.css') }}>

    
    <link rel="shortcut icon" href={{ url('backend/assets/images/favicon.png') }}>
    <link rel="apple-touch-icon-precomposed" href={{ url('backend/assets/images/favicon.png') }}>
        ...
        <div id="page" class="">
            ...
            <div class="layout-wrap">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('admin.home') }}" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src={{ url('backend/assets/images/logo/logo.png') }} data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" >
                        </a>
                    ...
                    <div class="section-menu-left-wrap">
                        <div class="center">
                                ...
                                <ul class="menu-list">
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.product-detail', ['id' => 1]) }}">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.add-attributes') }}" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.oder-list') }}" class="">
                                                    <div class="text">Order list</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.oder-detail') }}" class="">
                                                    <div class="text">Order detail</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.oder-tracking') }}" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.add-new-user') }}" class="">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.sign-up') }}" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.all-roles') }}" class="">
                                                    <div class="text">All roles</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.create-role') }}" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.list-faq') }}" class="">
                                                    <div class="text">list-faqs</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.add-faq') }}" class="">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.blog.index') }}" class="">
                                                    <div class="text">List Blogs</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.blog.create') }}" class="">
                                ...
                                <ul class="menu-list">
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.states') }}" class="">
                                    ...
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.list-page') }}" class="">
                                                    <div class="text">List page</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.new-page') }}" class="">
                                                    <div class="text">New page</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.edit-page') }}" class="">
                          ...
                          <div class="center-item">
                                ...
                                <ul class="menu-list">
                                    <li class="menu-item">
                                        <a href="{{ route('admin.components') }}" class="">
                        ...
                        <div class="bot text-center">
                            <div class="wrap">
                                <div class="mb-20">
                                    <img src={{ url('backend/assets/images/menu-left/img-bot.png') }} alt="">
                                </div>
                                <div class="mb-20">
                        ...
                        <div class="wrap">
                            <div class="header-left">
                                <a href="{{ route('admin.home') }}">
                                    <img class="" id="logo_header_mobile" alt="" src={{ url('backend/assets/images/logo/logo.png') }} data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" data-width="154px" data-height="52px" data-retina="images/logo/logo@2x.png">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/17.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Dog Food Rachael Ray Nutrish®</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/18.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Natural Dog Food Healthy Dog Food</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/19.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Freshpet Healthy Dog Food and Cat</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/20.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Sojos Crunchy Natural Grain Free...</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/21.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Talha Nadeem</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/22.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Mega Pumpkin Bone</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src={{ url('backend/assets/images/products/23.png') }} alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ route('admin.product-list') }}" class="body-text">Mega Pumpkin Bone</a>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src={{ url('backend/assets/images/avatar/user-11.png') }} alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src={{ url('backend/assets/images/avatar/user-12.png') }} alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src={{ url('backend/assets/images/avatar/user-13.png') }} alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4" >
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-1.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-2.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-3.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-4.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-5.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-6.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-7.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-8.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src={{ url('backend/assets/images/apps/item-9.png') }} alt="">
                                                        </div>
                                                        <a href="#">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src={{ url('backend/assets/images/avatar/user-1.png') }} alt="">
                                                </span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3" >
                                            ...
                                            <li>
                                                <a href="{{ route('admin.login') }}" class="user-item">
                                                    <div class="icon">
