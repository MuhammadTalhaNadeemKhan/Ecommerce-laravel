...
<body class="body">
            ...
            <div class="wrap-login-page sign-up">
                <div class="flex-grow flex flex-column justify-center gap30">
                    ...
                    <div class="login-box">
                        ...
                        <form class="form-login flex flex-column gap24" method="POST" action="{{ route('admin.sign-up.submit') }}">
                            @csrf
                            <fieldset class="name">
                                <div class="body-title mb-10">Your username <span class="tf-color-1">*</span></div>
                                <div class="flex gap10">
                                    <input class="flex-grow" type="text" placeholder="First name" name="name" tabindex="0" value="{{ old('name') }}" aria-required="true" required="">
                                    <input class="flex-grow" type="text" placeholder="Last name" name="name" tabindex="0" value="{{ old('name') }}" aria-required="true" required="">
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="password">
                                ...
                                <input class="password-input" type="password" placeholder="Enter your password" name="password_confirmation" aria-required="true" required="">
                                <span class="show-pass">
                                    <i class="icon-eye view"></i>
                                    <i class="icon-eye-off hide"></i>
                                </span>
    ...
    <script src={{ url('backend/assets/js/bootstrap-select.min.js') }}></script>
