            ...
            <div class="wrap-login-page">
                <div class="flex-grow flex flex-column justify-center gap30">
                    ...
                    <div class="login-box">
                        ...
                        <form class="form-login flex flex-column gap24" method="POST" action="{{ route('admin.login.submit') }}">
                            @csrf
                        ...
                        <div class="body-text text-center">
                            ...
                            <a href="{{ route('admin.sign-up') }}"  class="body-text tf-color">Register Now</a>
                        </div>
                    </div>
                </div>
